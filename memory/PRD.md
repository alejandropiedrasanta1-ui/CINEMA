...
- 2026-04-17: **Swap nombre/tipo extendido a Dashboard y Calendario** — El toggle "Mostrar Tipo de Evento primero" en Apariencia ahora afecta también Dashboard (lista Próximas Reservas) y Calendario (chips de eventos en cada día). Consistencia visual completa.
