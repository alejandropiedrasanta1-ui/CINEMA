...
- 2026-04-22: **3 mejoras**: (1) Nuevo estilo Dashboard "Línea Paquete" (muestra badge Básico/Intermedio/Completo en vez del monto). Tarjeta mejorado a ancho completo con más espacio. Total 5 estilos: Línea, Línea Paquete, Tarjeta, Compacto, Banda. (2) Socios: Botón "Asignar evento" en cada card con panel selector de reservas + honorario. Toggle Pendiente↔Pagado en lista de eventos expandible. Botón quitar socio de evento.
