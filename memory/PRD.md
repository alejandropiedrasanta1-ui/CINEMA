...
- 2026-04-16: **Rediseño completo layouts Formulario** — 7 diseños con layout estructural real. Layout `fullscreen` (Aurora): cubre toda la pantalla. Layout `floating` (Flotante, Tarjeta, App, Popup, Minimal, Cristal): overlay+card centrado sobre fondo oscuro/blur. Thumbnails en Apariencia con badge "popup"/"full". Ambos formularios (Reserva y Socio) soportan los dos layouts. Botón Close (X) + cierre al click en overlay.
